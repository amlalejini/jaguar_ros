...
#
# ~~~ IMPORTANT ~~~
# This driver was taken from https://github.com/ros-drivers/axis_camera
# This module is a modified version of the official ROS axis_camera driver.  All credit for the # functionality of this driver should go to the maintainers of the axis_camera git repo.
...
def updateArgs(arg_defaults):
    ...
    args = arg_defaults
    args['hostname'] = rospy.get_param("jag_axis_cam/hostname", arg_defaults['hostname'])
    args['username'] = rospy.get_param("jag_axis_cam/username", arg_defaults['username'])
    args['password'] = rospy.get_param("jag_axis_cam/password", arg_defaults['password']) 
